...
## 🚀 Features
 - 🕰️ Calculation of minimum and maximum time of time interval
 - ⏳ Calculation and partitioning of time interval into time sub-intervals
 - 📽️ Presentation of the subnetworks in each time sub-period through calculation of adjacency matrices
...
```bash
git clone https://github.com/kpavlis/social-network-analysis.git
